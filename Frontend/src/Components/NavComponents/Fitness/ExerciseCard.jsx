                    ...
                    <div className="">
                        ...
                        <div className="flex-auto justify-evenly">
                            ...
                            <div className="flex">
                                ...
                                <div className="ml-auto mb-5 mt-4 items-center justify-center">
                                    <button onClick={() => setShow(!show)} type="button" className="inline-flex justify-center w-full rounded-md border border-transparent shadow-sm bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                        Expand
